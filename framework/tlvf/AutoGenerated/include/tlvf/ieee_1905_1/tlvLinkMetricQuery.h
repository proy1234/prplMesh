...
class tlvLinkMetricQuerySpecificNeighbor;
...
class tlvLinkMetricQuerySpecificNeighbor : public BaseClass
{
    public:
        tlvLinkMetricQuerySpecificNeighbor(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit tlvLinkMetricQuerySpecificNeighbor(std::shared_ptr<BaseClass> base, bool parse = false);
