 ...
 *
 * The NL80211 is the 802.11 Netlink-based userspace interface for the new cfg80211 configuration
...
public:
     ...
     *
     * Calls base class constructor and increases the internal buffer size of the socket.
     */
    nl80211_socket();
     ...
     */
    virtual ~nl80211_socket();

    /**
     * @brief Connects the Netlink socket.
     *
     * Calls base class method with the same name and then obtains the "nl80211" family id, which
